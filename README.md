...
homeserver is the state. passwords are generated by the homeserver (not user-provided), shown to the user once, and should be changed in the matrix client after first login.
